...
public class slaObject implements java.io.Serializable {
	...
	@org.kie.api.definition.type.Label("slaResult")
	private java.util.List<com.myspace.claimsconnect_rulesbase.slaResult> slaResult;
	...
	public java.util.List<com.myspace.claimsconnect_rulesbase.slaResult> getSlaResult() {
		return this.slaResult;
	}

	public void setSlaResult(
			java.util.List<com.myspace.claimsconnect_rulesbase.slaResult> slaResult) {
